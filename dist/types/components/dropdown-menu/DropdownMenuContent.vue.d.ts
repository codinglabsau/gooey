...
declare const _default: __VLS_WithTemplateSlots<import("vue").DefineComponent<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DropdownMenuContentProps & {
    class?: any;
}>, {
    sideOffset: number;
...
}, string, import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DropdownMenuContentProps & {
    class?: any;
}>, {
    sideOffset: number;
}>>> & Readonly<{
