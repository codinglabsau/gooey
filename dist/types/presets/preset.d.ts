/**
 * @deprecated Import from '@codinglabsau/gooey/presets/v3' instead
 *
 * This file is kept for backwards compatibility with existing consumers.
 * For new projects, use the versioned presets:
