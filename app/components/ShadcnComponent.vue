...
<template>
  <div>
    <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">
      ...
      <span v-if="modified" class="underline">modified</span> Shadcn-vue component.
    </h2>

    <p class="mt-6 text-lg leading-8 text-card-foreground">
      <span v-if="modified">
        This component is imported from Shadcn Vue
        <span class="underline">with</span> modifications.
      </span>
    ...
    <div class="mt-10 flex items-center gap-x-6">
      <Button as-child>
        <a :href="`https://www.shadcn-vue.com/docs${currentRoute.value.path}`" target="__blank">
          See Shadcn Vue Docs
        </a>
