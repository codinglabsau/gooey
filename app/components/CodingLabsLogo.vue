<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 425.2 595.3">
    <!-- Juggling dots -->
    <circle class="fill-[#f95e08]" cx="323.5" cy="93.9" r="17.8" />

    <circle class="fill-[#f95e08]" cx="271.1" cy="65.8" r="10.4" />

    <circle class="fill-[#f95e08]" cx="327" cy="20.4" r="10.4" />
    ...
    <rect
      ...
      width="142.4"
      height="38.3"
      transform="rotate(15.91 281.4 140.05)"
      class="fill-[#212121] dark:fill-white"
    />
    ...
    <!-- Face -->
    <circle class="fill-[#f95e08]" cx="273.7" cy="333.9" r="24.5" />

    <circle class="fill-[#f95e08]" cx="228.2" cy="290.9" r="15.6" />
