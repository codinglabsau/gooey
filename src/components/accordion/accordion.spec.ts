describe("template spec", () => {
  ...
  it("renders basic content from array", () => {
    ...
    cy.get('[data-cy="contentBasic"] .accordion-content').first().should("be.visible").and("have.text", content.first.content);
  });
  ...
  it("renders custom content ", () => {
    ...
    cy.get('[data-cy="contentCustom"] .accordion-content img').should("have.attr", "src", "/logo.svg").and("be.visible");
  })
})
